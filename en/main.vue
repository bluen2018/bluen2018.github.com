				...
				<div id="rev_slider_4_1" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.0.7">
					<ul>	<!-- SLIDE  -->
						<li data-index="rs-16" data-transition="zoomout" data-slotamount="default"  data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="2000"  data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off"  data-title="Intro" data-description="">
							<!-- MAIN IMAGE -->
							<img src="images/slide-01.jpg"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina>
							<!-- LAYERS -->
							...
							<div class="tp-caption NotGeneric-SubTitle   tp-resizeme rs-parallaxlevel-0" 
								...
								style="z-index: 6; white-space: nowrap;">Global Water Eco-Technology hidden Champion Group in KOREA
							</div>
						...
						<li data-index="rs-17" data-transition="fadetotopfadefrombottom" data-slotamount="default"  data-easein="Power3.easeInOut" data-easeout="Power3.easeInOut" data-masterspeed="1500"    data-rotate="0"  data-saveperformance="off"  data-title="Parallax" data-description="">
							<!-- MAIN IMAGE -->
							<img src="images/slide-02.jpg"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina>
							<!-- LAYERS -->
							...
							<div class="tp-caption NotGeneric-Title   tp-resizeme rs-parallaxlevel-5" 
								...
								style="z-index: 5; white-space: nowrap;">Water Technology BLUE N
							</div>
							...
							<div class="tp-caption NotGeneric-SubTitle   tp-resizeme rs-parallaxlevel-5" 
								...
								style="z-index: 6; white-space: nowrap;">Convergent Water Treatment and Equipment Solutions 
							</div>
						...
						<li data-index="rs-18" data-transition="zoomin" data-slotamount="7"  data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="2000"   data-rotate="0"  data-saveperformance="off"  data-title="Ken Burns" data-description="">
							<!-- MAIN IMAGE -->
							<img src="images/slide-03.jpg"  alt=""  data-bgposition="center center" data-kenburns="on" data-duration="10000" data-ease="Linear.easeNone" data-scalestart="100" data-scaleend="120" data-rotatestart="0" data-rotateend="0" data-offsetstart="0 0" data-offsetend="0 0" data-bgparallax="10" class="rev-slidebg" data-no-retina>
							<!-- LAYERS -->
							...
							<div class="tp-caption tp-shape tp-shapewrapper   tp-resizeme rs-parallaxlevel-0" 
								...
								style="z-index: 5;background-color:rgba(34, 34, 34, 0.85);"> 
							</div>
							...
							<div class="tp-caption NotGeneric-Title   tp-resizeme rs-parallaxlevel-0" 
								...
								style="z-index: 6; white-space: nowrap;">WATER TECHs
							</div>
							...
							<div class="tp-caption NotGeneric-SubTitle   tp-resizeme rs-parallaxlevel-0" 
								...
								style="z-index: 7; white-space: nowrap;">Hopely Designed by Blue N
							</div>
						</li>
						...
						<li data-index="rs-20" data-transition="zoomin" data-slotamount="7"  data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="2000" data-rotate="0"  data-saveperformance="off"  data-title="Love it?" data-description="">
							<!-- MAIN IMAGE -->
							<img src="images/slide-04.jpg"  alt=""  data-bgposition="center center" data-kenburns="on" data-duration="10000" data-ease="Linear.easeNone" data-scalestart="100" data-scaleend="120" data-rotatestart="0" data-rotateend="0" data-offsetstart="0 -500" data-offsetend="0 500" data-bgparallax="10" class="rev-slidebg" data-no-retina>
							<!-- LAYERS -->
							...
							<div class="tp-caption NotGeneric-Title   tp-resizeme rs-parallaxlevel-0" 
								...
								style="z-index: 5; white-space: nowrap;">Love our planet?
							</div>
							...
							<div class="tp-caption NotGeneric-SubTitle   tp-resizeme rs-parallaxlevel-0" 
								...
								style="z-index: 6; white-space: nowrap;">Get future with us!
							</div>
	...
	<div class="icon-box-container">
		...
		<div class="one-third column">
			<div class="icon-box">
				...
				<h3>1. Water resource Analyze</h3>
				<p>Water quality data collected by automated automated analytics systems supports integrated management solutions.</p>
			</div>
		</div>
		<!-- Icon Box End -->
		...
		<div class="one-third column">
			<div class="icon-box">
				...
				<h3>2. Water treatment data control</h3>
				<p>we provide effective solutions for decomplying and removing non-degradable contaminants, non-viscent contaminants, and separating them from the water flow to ensure efficient management according to environmental policies.</p>
			</div>
		</div>
		<!-- Icon Box End -->
		...
		<div class="one-third column">
			<div class="icon-box">
				...
				<h3>3. Wide water pipe integrated info.</h3>
				<p>Reduce the cost of installation and operating expenses by providing a system of measuring the flow essential for the establishment of an integrated management network for efficient use of public water resources.</p>
			</div>
		</div>
		<!-- Icon Box End -->
...
<div class="container">
	<div class="sixteen columns">
		...
		<!-- Headline -->
		<div class="headline no-margin"><h3>Our Partners</h3></div>
