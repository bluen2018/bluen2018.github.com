...
<div class="padding-right">
	...
	<div class="post">
		...
		<div class="post-content">
			...
			<a class="button color post-entry" href="Index(MAIN&MENU)(EN).html">Continue Reading</a>
		</div>
	</div>
	...
	<div class="post">
		...
		<div class="post-content">
			<div class="post-title"><h2><a href="Index(MAIN&MENU)(EN).html">This is a post with video embed (Video Format)</a></h2></div>
			<div class="post-meta"><span><i class="fa fa-calendar"></i>On 10 August, 2012</span> <span><i class="fa fa-user"></i>By <a href="#">admin</a></span> <span><i class="fa fa-comment"></i>With <a href="#">12 Comments</a></span></div>
			<div class="post-description">
	...
	<div class="post">
		...
		<div class="post-content">
			<div class="post-title"><h2><a href="Index(MAIN&MENU)(EN).html">This is a post with gallery (Gallery Format)</a></h2></div>
			<div class="post-meta"><span><i class="fa fa-calendar"></i>On 10 August, 2012</span> <span><i class="fa fa-user"></i>By <a href="#">admin</a></span> <span><i class="fa fa-comment"></i>With <a href="#">12 Comments</a></span></div>
			<div class="post-description">
