	...
	<div class="icon-box-container">
		...
		<div class="one-third column">
			<div class="icon-box">
				...
				<h3>2. 水处理数据资源管理</h3>
				<p>提供非点源污染处理和难分解性污染水净化解决方案。能通过各种环保市场和政府的规格。提供最高效率的解决方案。</p>
			</div>
		</div>
		<!-- Icon Box End -->
		...
		<div class="one-third column">
			<div class="icon-box">
				...
				<h3>3. 广域上水综合管理信息</h3>
				<p>由于公共水资源的高效率运用。测定水流量是建立管理系统时必须要求。通过管理系统能减少设备运用费用。</p>
			</div>
		</div>
		<!-- Icon Box End -->
			...
			<div class="four columns">
				...
				<div class="item-description related">
					...
					<p>	水处理的方式包括物理处理和化学处理。
						人类进行水处理的方式已经有相当多年历史，
						物理方法包括利用各种孔径大小不同的滤材，
						利用吸附或阻隔方式，将水中的杂质排除在外，
						吸附方式中较重要者为以活性炭进行吸附，阻隔方法则是将水通过滤材，
						让体积较大的杂质无法通过，进而获得较为干净的水。</p>
				</div>
			</div>
		...
		var revapi4;
					if(tpj("#rev_slider_4_1").revolution == undefined){
						...
						revapi4 = tpj("#rev_slider_4_1").show().revolution({
							sliderType:"standard",jsFileLocation:"js/",
							sliderLayout:"auto",
							dottedOverlay:"none",
							delay:9000,
							navigation: {
