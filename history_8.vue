...
<div class="padding-right">
	...
	<div class="post post-page">
		...
		<div class="post-content">
			<div class="post-title"><h2><a href="HISTORY_POST(8).html"> 2017.12.12. 본사 이전</a></h2></div>
			<div class="post-meta"><span><i class="fa fa-calendar"></i>On 12 December, 2017</span> <span><i class="fa fa-user"></i>By <a href="#">admin</a></span> <span><i class="fa fa-comment"></i>With <a href="#">12 Comments</a></span></div>
			<div class="post-description">
				<p>2017년 12월 18일 블루앤유한회사는 전남환경산업진흥원 BI센터로 본점을 이전하였습니다.</p>
